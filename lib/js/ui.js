...
function miniTab(cb,opener,closeCB){
    ...
    */
    ...
    var closeBtn = document.createElement("button"); closeBtn.innerHTML = String.fromCharCode(10006); 
...
function notification(message,bg,color,closeBtnColor,showTime){
    ...
    notificationClose.innerHTML = String.fromCharCode(10006); notificationClose.className = "yotta-notification-close"
